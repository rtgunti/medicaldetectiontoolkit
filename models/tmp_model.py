...
#         print("class_logits_before", class_logits.shape)
...
#             print("j {} b {} i {} class_id {}".format(j, b.cpu().data.numpy(), i, class_id.cpu().data.numpy()))
...
#         print("class_layer_outputs", class_layer_outputs[0][0].shape)
#         print("class_layer_outputs", len(class_layer_outputs[0][0][1][0]))
        # Concatenate layer outputs
        # Convert from list of lists of level outputs to 
        # list of lists of outputs across levels. (a, b, c are level and 1, 2 are batch_ix)
...
#         print("len(class_logits)", len(class_logits))
#         print("class_logits", class_logits[0].shape)
