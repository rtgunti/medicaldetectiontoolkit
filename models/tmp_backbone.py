...
class FPN(nn.Module):
    ...
    def forward(self, x):
        ...
        enc_out_list = [c0_out, c1_out, c2_out, c3_out, c4_out, c5_out]
        pre_out_list = []
        if self.sixth_pooling:
            ...
            enc_out_list.extend([c6_out])
            pre_out_list.extend([p6_pre_out])
        else:
        ...
        pre_out_list = pre_out_list + [p2_pre_out, p3_pre_out, p4_pre_out, p5_pre_out]
        ...
        if self.operate_stride1:
            ...
            pre_out_list = [p0_pre_out, p1_pre_out] + pre_out_list

# #         plot feature map shapes for debugging.
#         print("FPN Encoder Output Shapes")
#         for level, ii in enumerate(enc_out_list):
#             print ("level {} : {}".format(level,ii.shape))
#         print("Pre Output Shapes")
#         for level, ii in enumerate(reversed(pre_out_list)):
#             print("level {} : {}".format(len(pre_out_list)-level,ii.shape))  
#         print("Pyramid Output Shapes")
#         for level, ii in enumerate(reversed(out_list)):
#             print("level {} : {}".format(len(out_list)-level,ii.shape))            
